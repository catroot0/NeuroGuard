...
async function learnMoreButton(interaction: ButtonInteraction) {
  ...
  .setDescription(
    `When you click **Verify**, the bot uses Discord OAuth2 to temporarily access your account's basic info — including your server list — to check if it meets this server's safety standards.\n\n` +
    `It automatically scans for involvement in:\n` +
    `• NSFW or inappropriate communities\n` +
    `• Servers with exploitative, spammy, or disruptive themes\n` +
    `• Known raiding, "condo", or malicious networks\n\n` +
    `❌ If your account is found in restricted servers, you will be **automatically banned** from this server.\n` +
    `📩 A direct message will be sent with a link to appeal if you believe the ban was a mistake.\n\n` +
